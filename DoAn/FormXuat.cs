            ...
            else
            {
               ...
               conn.Open();
                ...
                else
                {
                    ...
                    conn.Close();
                    conn.Open();
                    SqlCommand cmd4 = new SqlCommand("select MaMT from dbo.MayTinh where MaMT ='" + phieuXuat.MaMT + "'", conn);
                    ...
                    else
                    {
                        conn.Close();
                        conn.Open();
                        string QuerrySelectDonGia = "select DonGia from dbo.MayTinh where MaMT = '" + phieuXuat.MaMT + "'";
